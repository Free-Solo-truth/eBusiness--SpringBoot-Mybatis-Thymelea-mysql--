...
public class IndexServiceImpl implements IndexService {
	...
	public String selectAllGoodsByPage1(Model model, int currentPage, String act) {
		//共多少个商品
		int totalCount = indexRepository.selectAllGoods1();
		//计算共多少页
		int pageSize = 5;
		int totalPage = (int)Math.ceil(totalCount*1.0/pageSize);
		List<Goods> typeByPage1 = indexRepository.selectAllGoodsByPage1((currentPage-1)*pageSize, pageSize);
		model.addAttribute("allGoods", typeByPage1);
		return "user/index";
	}
	@Override
